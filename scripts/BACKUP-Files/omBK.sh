...
then
	...
	echo "--------------------------------------------------------------" |& tee -a $SOURCEDIR/logs/$COMPILER/apps.log
	echo "Installation Command :"  |& tee -a $SOURCEDIR/logs/$COMPILER/apps.log
	echo ""  |& tee -a $SOURCEDIR/logs/$COMPILER/apps.log
	# Print the installation command !
	echo "spack install $PAR $APP %$COMPILER $DEPS" |& tee -a $SOURCEDIR/logs/$COMPILER/apps.log
	echo "--------------------------------------------------------------" |& tee -a $SOURCEDIR/logs/$COMPILER/apps.log
